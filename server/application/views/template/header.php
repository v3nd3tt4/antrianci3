...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?=base_url()?>sneat/assets/"
...
<body>
    <!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-navbar <?=$link==''?'layout-without-menu':''?>">
